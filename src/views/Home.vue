      ...
      <div class="card-inner active" id="about-card">
        <div class="card-wrap" style="">
          ...
          <div class="content services">
            <!-- title -->
            <div class="title"><span class="first-word">My</span> Services</div>
          ...
          <div class="content fuct">
            <!-- title -->
            <div class="title"><span class="first-word">Fun</span> Fact</div>
          ...
          <div class="content clients">
            <!-- title -->
            <div class="title">
              <div class="first-letter">Clients</div>
            </div>
      ...
      <div class="card-inner" id="resume-card">
        <div class="card-wrap" style="">
          ...
          <div class="content resume">
            <!-- title -->
            <div class="title">
              <div class="first-letter">Resume</div>
            </div>
          ...
          <div class="content skills">
            <!-- title -->
            <div class="title"><span class="first-word">My</span> Skills</div>
          ...
          <div class="content testimonials">
            <!-- title -->
            <div class="title">
              <div class="first-letter">Testimonials</div>
            </div>
                  ...
                  <div class="owl-carousel owl-loaded owl-drag">
                    <div class="owl-stage-outer">
                      <div
                        class="owl-stage"
                        style="
                          transform: translate3d(-1049px, 0px, 0px);
                          transition: all 0s ease 0s;
                          width: 3675px;
                        "
                      >
                        <div class="owl-item cloned" style="width: 524.969px">
                          <div class="item">
                            <div class="revs-item" style="max-width: 524.969px">
                              <div class="text">
                        ...
                        <div class="owl-item active" style="width: 524.969px">
                          <div class="item">
                            <div class="revs-item" style="max-width: 524.969px">
                              <div class="text">
                                Lorem ipsum dolor sit amet, consectetur
                        ...
                        <div class="owl-item" style="width: 524.969px">
                          <div class="item">
                            <div class="revs-item" style="max-width: 524.969px">
                              <div class="text">
                                Lorem ipsum dolor sit amet, consectetur
      ...
      <div class="card-inner" id="works-card">
        <div class="card-wrap" style="">
          ...
          <div class="content works">
            <!-- title -->
            <div class="title">
              <span class="first-word">Recent</span> Works
            </div>
            ...
            >
              ...
              <div
                class="
                  ...
                  border-line-h
                "
                style="position: absolute; left: 49.9973%; top: 0px"
              >
                <div class="box-item">
                  <div class="image">
                    <a
              ...
              <div
                class="
                  ...
                  border-line-h
                "
                style="position: absolute; left: 49.9973%; top: 251.984px"
              >
                <div class="box-item">
                  <div class="image">
                    <a
              ...
              <div
                class="
                  ...
                  border-line-h
                "
                style="position: absolute; left: 0%; top: 697.703px"
              >
                <div class="box-item">
                  <div class="image">
                    <a
      ...
      <div class="card-inner contacts" id="contacts-card">
        <div class="card-wrap" style="">
          ...
          <div class="content contacts">
            <!-- title -->
            <div class="title">
              <span class="first-word">Contact</span> Form
            </div>
